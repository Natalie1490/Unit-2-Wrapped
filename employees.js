...
const employee1 = new Employee("John", "Day shift: M-F");
const employee2 = new Employee("Jane", "Night shift: Weekends");
...
const empOne = new Employee("Jess", "Flex: M-F");
...
class Manager extends Employee {
  constructor(name, shifts, employee) {
    super(name);
    super(shifts);
    this.employee = (John, Jane, Nick, Jess);
  }
